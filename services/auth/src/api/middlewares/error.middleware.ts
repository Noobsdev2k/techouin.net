...
dotenv.config()
import { Api401Error, Api403Error, Api404Error, Api409Error, BaseError, BusinessLogicError } from './error.response'

const returnError = (err: BaseError | any, req: Request, res: Response, next: NextFunction) => {
